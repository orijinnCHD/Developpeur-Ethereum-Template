...
/*Voting system
    ...
    -check if we have tie vote and try again a voting session.
...
contract Voting is Ownable{
    ...
    address[] private addressVoters; // bonus : reset the voters mapping
...
//-------------------modifier-------------------------------------//
    ...
    */
    modifier onlyWhitelisters(){
        ...
        require( voters[msg.sender].isRegistered, "you can't participate and view information in this voting session" );
        _;
    ...
    */
    ...
    /* onlyProposalsCreated : 
        ...
        -- security : admin mislead set workflowStatus.
    */
...
//------------------- function----------------------------------//
    ...
    */
    ...
    /* getStatus : 
        -- Whitelisters can visualise current workflowStatus.
    */
    ...
    */
    ...
    /* getWinner : 
        ...
        ** bonus isEqualVote : check if winner is equal with anothers proposals, True: reset and retry the voting session
    */
    function getWinner()public onlyStatus( WorkflowStatus.VotesTallied ) onlyWhitelisters onlyProposalsCreated returns( string memory  ){

        uint winningProposalId = findTheWinner();
        bool isEqualVote = checkEqualVote( winningProposalId );
        if( isEqualVote ){
            ResetTheVote();
            return unicode"there is equality, the vote session is restarting";
        }
        else
    ...
    */
    function ResetTheVote() internal {
